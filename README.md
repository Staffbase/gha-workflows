...
jobs:
  <action name>:
    uses: Staffbase/gha-workflows/.github/workflows/template_*.yml@v5.1.0
    with:
      ...
```
...
jobs:
  autodev:
    uses: Staffbase/gha-workflows/.github/workflows/template_autodev.yml@v5.1.0
    with:
...
jobs:
  jira_annotate:
    uses: Staffbase/gha-workflows/.github/workflows/template_jira_tagging.yml@v5.1.0
    with:
...
jobs:
  ld_code_references:
    uses: Staffbase/gha-workflows/.github/workflows/template_launchdarkly_code_references.yml@v5.1.0
    with:
...
jobs:
  update_release_draft:
    uses: Staffbase/gha-workflows/.github/workflows/template_release_drafter.yml@v5.1.0
    with: 
...
jobs:
  new_version:
    uses: Staffbase/gha-workflows/.github/workflows/template_release_version.yml@v5.1.0
    with:
...
jobs:
  stale:
    uses: Staffbase/gha-workflows/.github/workflows/template_stale.yml@v5.1.0
    with:
...
jobs:
  techdocs:
    uses: Staffbase/gha-workflows/.github/workflows/template_techdocs.yml@v5.1.0
    with:
...
jobs:
  trigger-testio-test:
    uses: Staffbase/gha-workflows/.github/workflows/template_testio_trigger_test.yml@v5.1.0
    with:
...
jobs:
  yamllint:
    uses: Staffbase/gha-workflows/.github/workflows/template_yaml.yml@v5.1.0
    with:
