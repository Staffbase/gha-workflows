...
jobs:
  <action name>:
    uses: Staffbase/gha-workflows/.github/workflows/template_*.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
...
jobs:
  dependabot:
    uses: Staffbase/gha-workflows/.github/workflows/template_automerge_dependabot.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions: {}
    with:
...
jobs:
  autodev:
    uses: Staffbase/gha-workflows/.github/workflows/template_autodev.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
    with:
...
jobs:
  changeset-check:
    uses: Staffbase/gha-workflows/.github/workflows/template_changeset_check.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
      pull-requests: write
```
...
jobs:
  changeset-release:
    uses: Staffbase/gha-workflows/.github/workflows/template_changeset_release.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
    with:
...
jobs:
  flaky-tests:
    uses: Staffbase/gha-workflows/.github/workflows/template_flaky_tests.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      checks: read
      contents: read
    with:
...
jobs:
  gitops:
    uses: Staffbase/gha-workflows/.github/workflows/template_gitops.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
    with:
...
jobs:
  jira_annotate:
    uses: Staffbase/gha-workflows/.github/workflows/template_jira_tagging.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
    with:
...
jobs:
  ld_code_references:
    uses: Staffbase/gha-workflows/.github/workflows/template_launchdarkly_code_references.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
    with:
...
jobs:
  block:
    uses: Staffbase/gha-workflows/.github/workflows/template_merge_block.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      pull-requests: write
    with:
...
jobs:
  update_release_draft:
    uses: Staffbase/gha-workflows/.github/workflows/template_release_drafter.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: write
      pull-requests: read
    with:
...
jobs:
  new_version:
    uses: Staffbase/gha-workflows/.github/workflows/template_release_version.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
    with:
...
jobs:
  trufflehog:
    permissions:
      contents: read
    uses: Staffbase/gha-workflows/.github/workflows/template_secret_scan.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
```
...
jobs:
  stale:
    uses: Staffbase/gha-workflows/.github/workflows/template_stale.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: write
      pull-requests: write
      issues: write
...
jobs:
  techdocs:
    uses: Staffbase/gha-workflows/.github/workflows/template_techdocs_monorepo.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
    secrets:
...
jobs:
  techdocs:
    uses: Staffbase/gha-workflows/.github/workflows/template_techdocs.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
    with:
...
jobs:
  terraform:
    uses: Staffbase/gha-workflows/.github/workflows/template_terraform_format.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
      pull-requests: write
    with:
...
jobs:
  yamllint:
    uses: Staffbase/gha-workflows/.github/workflows/template_yaml.yml@b780a238f60320f9513e8750d87b2cf3f4660978 # v17.0.1
    permissions:
      contents: read
      checks: write
    with:
